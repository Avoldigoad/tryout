...
<div class="wrapper">
  ...
  <div class="content-wrapper " style="height:91.6vh; background-color: #fff; color:#161A30;">
    ...
    <section class="content">
        <div class="content-wraper shadow p-3 mb-5 bg-body rounded " style="width: 800px; margin-left: 140px">
            ...
            <div class="ml-4">
                ...
                <h5 for="">Kategori : <?= $detail['nama_kategori'] ?></h5>
                    ...
                    <div class="footer text-center">
                        <a href="../buku.php"><button type="button" class="btn btn-secondary">Close</button></a>
                    </div>
        </div>
    </section>
  </div>
